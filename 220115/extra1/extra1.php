...
$url = "https://www.googleapis.com/books/v1/volumes?q=%E5%A4%8F%E7%9B%AE%E6%BC%B1%E7%9F%B3";
...
//以下課題extra1部分
$extra1_1_title = $arr["items"][1]["volumeInfo"]["title"];
$extra1_1_authors = $arr["items"][1]["volumeInfo"]["authors"][0];
$extra1_1_pagecount = $arr["items"][1]["volumeInfo"]["pageCount"];
...
echo "<br>extra1-3<br>";
echo "<a href='volumes.json'>volumes.json</a><br>";
